...
export const notificationTypeOptions = [
  ...
  { value: "butler_rejected", label: "拒单通知", description: "管家拒单后通知管理员和调配员。" },
  ...
  { value: "stay_extension_requested", label: "续住申请通知", description: "管家上报客人续住后通知前台和调配员确认。" },
  { value: "stay_extension_approved", label: "续住确认通知", description: "续住确认后通知相关管家新的预计离店时间。" },
  { value: "stay_extension_rejected", label: "续住驳回通知", description: "续住申请驳回后通知上报管家。" },
